             ...
             <div class="row">
                ...
                <div class="col-md-12">
                   ...
                   <div class="input-group mb-3">
                        ...
                        <button class="btn btn-outline-secondary dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{!empty($sccode) ? $sccode : 'Select'}}</button>
                        ...
                        <div id="shippingCharges">
                            ...
                            @foreach ($scharges as $scharge)
                                <div class="form-check form-check">
                                    <input class="form-check-input" type="radio" data="{{!empty($scharge->free_delivery_amount) && cartTotal() >= $scharge->free_delivery_amount ? 0 : $scharge->charge}}" name="shipping_charge" id="scharge{{$scharge->id}}" value="{{$scharge->id}}" {{$loop->first ? 'checked' : ''}}>
             ...
             <div class="row">
                ...
                {{-- <div class="col-md-12">
                   ...
                   <div class="input-group mb-3">
                        ...
                        <div class="input-group-prepend">
                        <button class="btn btn-outline-secondary dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{!empty($user->country_code) ? $user->country_code : 'Select'}}</button>
                        <div class="dropdown-menu country-codes">
                            @foreach ($ccodes as $ccode)
                                <a class="dropdown-item" data-country_code="{{$ccode['code']}}" href="#">{{$ccode['name']}} ({{$ccode['code']}})</a>
                            @endforeach
                        </div>
                        </div>
                        <input type="text" name="billing_number" class="form-control" placeholder="{{__('Billing Phone')}}" value="{{$bnumber}}">
                    </div>
                </div> --}}
             </div>
          </div>
